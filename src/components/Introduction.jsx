    ...
    <div className="flex flex-col items-center place-content-center">
      <article className="px-4 py-8 font-serif max-w-4xl">
        ...
        <ul className="py-4 list-disc list-inside">
          ...
          <li>
            the number of particles controls the total number of particles
            during the simulation, i.e., the number of particles of each
            material block is the average of the total number of particles,
          </li>
